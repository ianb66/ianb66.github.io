              ...
              <div className="space-y-6">
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg transform hover:-translate-y-1 transition-all duration-200">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <span className="font-semibold text-gray-900">Traffic Growth</span>
                  </div>
                  <div className="text-3xl font-bold text-gray-900">+247%</div>
                  <div className="text-sm text-gray-600 mt-1">Average increase in 6 months</div>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg transform hover:-translate-y-1 transition-all duration-200">
                  ...
                  <div className="text-3xl font-bold text-gray-900">5,200+</div>
                  <div className="text-sm text-gray-600 mt-1">Qualified leads per month</div>
                </div>
              </div>
            </div>
